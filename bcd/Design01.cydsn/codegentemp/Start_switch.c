...
{
    uint8 staticBits = (Start_switch_DR & (uint8)(~Start_switch_MASK));
    Start_switch_DR = staticBits | ((uint8)(value << Start_switch_SHIFT) & Start_switch_MASK);
}
...
{
	CyPins_SetPinDriveMode(Start_switch_0, mode);
}
...
{
    return (Start_switch_PS & Start_switch_MASK) >> Start_switch_SHIFT;
}
...
{
    return (Start_switch_DR & Start_switch_MASK) >> Start_switch_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(Start_switch_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Start_switch_0_INTR) != 0u) 
		{ 
			 Start_switch_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Start_switch_INTSTAT & Start_switch_MASK) >> Start_switch_SHIFT;
    }
