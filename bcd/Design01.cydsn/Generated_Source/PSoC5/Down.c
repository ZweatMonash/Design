...
*
* \funcusage
*  \snippet Down_SUT.c usage_Down_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Down_SUT.c usage_Down_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Down_SUT.c usage_Down_Read  
*******************************************************************************/
...
* preferred Down_Read() API because the 
* Down_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Down_SUT.c usage_Down_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Down_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Down_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Down_0_INTR       (First pin in the list)
    *  - Down_1_INTR       (Second pin in the list)
    *  - ...
    *  - Down_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Down_SUT.c usage_Down_SetInterruptMode
    *******************************************************************************/
    void Down_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Down_0_INTR) != 0u) 
		{ 
			 Down_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Down_SUT.c usage_Down_ClearInterrupt
    *******************************************************************************/
