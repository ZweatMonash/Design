...
*
*******************************************************************************/
void Clock_40_Start(void) 
{
    /* Set the bit to enable the clock. */
    Clock_40_CLKEN |= Clock_40_CLKEN_MASK;
	Clock_40_CLKSTBY |= Clock_40_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: Clock_40_Stop
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_40_Stop(void) 
{
    /* Clear the bit to disable the clock. */
    Clock_40_CLKEN &= (uint8)(~Clock_40_CLKEN_MASK);
	Clock_40_CLKSTBY &= (uint8)(~Clock_40_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: Clock_40_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_40_StopBlock(void) 
{
    if ((Clock_40_CLKEN & Clock_40_CLKEN_MASK) != 0u)
    {
...
#if defined(Clock_40__CFG3)
        CLK_DIST_AMASK = Clock_40_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = Clock_40_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* Clock_40__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(Clock_40_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(Clock_40_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: Clock_40_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_40_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        Clock_40_CLKSTBY &= (uint8)(~Clock_40_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: Clock_40_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_40_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = Clock_40_GetSourceRegister();
    uint16 oldDivider = Clock_40_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = Clock_40_CLKEN & Clock_40_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((Clock_40_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: Clock_40_GetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint16 Clock_40_GetDividerRegister(void) 
{
    return CY_GET_REG16(Clock_40_DIV_PTR);
}


/*******************************************************************************
* Function Name: Clock_40_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_40_SetModeRegister(uint8 modeBitMask) 
{
    Clock_40_MOD_SRC |= modeBitMask & (uint8)Clock_40_MODE_MASK;
}


/*******************************************************************************
* Function Name: Clock_40_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_40_ClearModeRegister(uint8 modeBitMask) 
{
    Clock_40_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(Clock_40_MODE_MASK));
}


/*******************************************************************************
* Function Name: Clock_40_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Clock_40_GetModeRegister(void) 
{
    return Clock_40_MOD_SRC & (uint8)(Clock_40_MODE_MASK);
}


/*******************************************************************************
* Function Name: Clock_40_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_40_SetSourceRegister(uint8 clkSource) 
{
    uint16 currDiv = Clock_40_GetDividerRegister();
    uint8 oldSrc = Clock_40_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        Clock_40_MOD_SRC |= CYCLK_SSS;
        Clock_40_MOD_SRC =
            (Clock_40_MOD_SRC & (uint8)(~Clock_40_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: Clock_40_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Clock_40_GetSourceRegister(void) 
{
    return Clock_40_MOD_SRC & Clock_40_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: Clock_40_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_40_SetPhaseRegister(uint8 clkPhase) 
{
    Clock_40_PHASE = clkPhase & Clock_40_PHASE_MASK;
}


/*******************************************************************************
* Function Name: Clock_40_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Clock_40_GetPhaseRegister(void) 
{
    return Clock_40_PHASE & Clock_40_PHASE_MASK;
}
