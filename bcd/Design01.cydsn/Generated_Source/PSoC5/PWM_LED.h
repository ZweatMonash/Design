...
**************************************/
#define PWM_LED_INIT_PERIOD_VALUE          (239u)
#define PWM_LED_INIT_COMPARE_VALUE1        (119u)
...
#define PWM_LED_DEFAULT_COMPARE1_MODE      (uint8)((uint8)3u <<  PWM_LED_CTRL_CMPMODE1_SHIFT)
